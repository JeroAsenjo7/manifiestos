...
# Variables
WORKDIR="tdCloud"
REPO_MANIFIESTOS="https://github.com/JeroAsenjo7/manifiestos.git"
REPO_HTML="https://github.com/JeroAsenjo7/static-website.git"
HTML_DIR="static-website"
...
echo "Accediendo a la página con el url del ingress http://local.service/"
